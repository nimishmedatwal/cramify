...
export default function Footer() {
  return (
    <>
    <footer>
    <div  Name="container footerContainer">
      <div className="footer-nav flex flex-around flex-start flex-g-1">
        <div className="col flex flex-column flex-start flex-g-1">
          ...
          <div className="social-medias flex flex-g-1">
            ...
            <a href="https://github.com/nimishmedatwal/" target="_blank" className="social-media flex">
            ...
            <a href="https://www.linkedin.com/in/nimishmedatwal/" target="_blank" className="social-media flex">
        ...
        <div className="col flex flex-column flex-g-1 flex-start"><h3 className="col-title">Company</h3>
      <nav className="col-list">
        <ul>
      ...
      <div className="copyright">Made with ❤️ by Nimish Medatwal 
      <br /><br/>© 2022 – All Rights Reserved.</div>
    </div>
  </footer>
